                ...
                <div style={{ background: "white", borderRadius: isMobile ? 12 : 14, boxShadow: "0 8px 32px rgba(26,29,94,0.08)", padding: isMobile ? "18px 16px" : "32px 36px", animation: "slideIn 0.3s ease both" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                    ...
                    <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
                      ...
                      >
                        <InlineEmailVerification
                          key={emailWidgetKey}
                          formLabel={form.jobFairName || "Job Fair Registration"}
                    ...
                    <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
                      ...
                      <Field label="Sex" required style={{ flex: isMobile ? "1 1 100%" : "1 1 180px" }} error={hasIssue("Gender is required.") ? "Gender is required." : undefined}>
