...
import jobstartHeroBg from "/assets/JOBSTART/jobstart.png";
...
interface JobStartPhoto {
  src: string;
  alt: string;
}

interface JobStartFolder {
  id: string;
  name: string;
  photos: JobStartPhoto[];
...
// e.g. { src: "/assets/jobstart-orientation-1.jpg", alt: "Batch orientation" }.
// Until then, `placeholderCount` controls how many empty slots show up so the
// folder doesn't look broken.

const JOBSTART_FOLDERS: JobStartFolder[] = [
  {
    id: "orientation",
    ...
    photos: [
      ...
      { src: "/assets/JOBSTART/orientation/5.jpeg", alt: "" },
      { src: "/assets/JOBSTART/orientation/6.jpeg", alt: "" },
      { src: "/assets/JOBSTART/orientation/7.jpeg", alt: "" },
      { src: "/assets/JOBSTART/orientation/8.jpeg", alt: "" },
    ],
    placeholderCount: 6,
  },
  {
  ...
  {
    id: "graduation",
    name: "JOBSTART GRADUATION & JOB PLACEMENT",
    photos: [],
    placeholderCount: 6,
  },
];
...
function PhotoCell({
  ...
  photo: JobStartPhoto;
  onOpenLightbox: (photo: JobStartPhoto) => void;
}) {
...
export default function JobStartPage() {
  ...
  const [lightbox, setLightbox] = useState<JobStartPhoto | null>(null);
  ...
  const selectedFolder = JOBSTART_FOLDERS.find(f => f.id === selectedFolderId) ?? null;
      ...
      <div style={{ minHeight: "100vh", background: COLORS.cream }}>
        ...
        <header style={{ background: COLORS.red, padding: "0 24px" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto", height: 58, display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.85rem", fontWeight: 600 }}>JobStart Program</span>
          </div>
        </header>
        ...
        >
          ...
          >
            ...
            >
              A DOLE youth employment facilitation program that helps Filipinos aged 18–24 bridge
              the gap between school and work through career coaching, life skills and technical
              training, and paid internships with private-sector employers.
            </p>
        ...
        <section style={{ background: COLORS.red, padding: isMobile ? "28px 24px" : "32px 24px" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto" }}>
            <p style={{
              ...
              <strong>Program Objective:</strong> To improve the employability of at-risk youth who are
              out of school, out of work, and not in training, through free life skills and technical
              training, one-on-one career coaching, and paid internships that lead to full-cycle
        ...
        <section style={{ padding: isMobile ? "40px 24px 0" : "56px 24px 0" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto" }}>
            ...
            <div style={{
              ...
              {[
                { icon: "🇵🇭", text: "Filipino citizen" },
                { icon: "🎂", text: "18 to 24 years old (17-year-olds may register if they turn 18 by the technical training stage)" },
                { icon: "🎓", text: "At least reached high school level" },
                { icon: "📋", text: "Not currently employed, studying, or undergoing training" },
              ].map((item, i) => (
                <div key={i} style={{
                  display:      "flex",
                  alignItems:   "flex-start",
            ...
            {!selectedFolder && (
              <div style={{ textAlign: "center", marginBottom: isMobile ? 28 : 36 }}>
                ...
                <p style={{ color: COLORS.bodyText, fontSize: "0.95rem", maxWidth: 480, margin: "0 auto" }}>
                  Browse JobStart highlights by folder. Tap a folder to view its photos.
                </p>
              </div>
            )}
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.95rem", lineHeight: 1.7, margin: "0 0 28px" }}>
              Visit the PESO Capiz office or contact us for more information on registration
