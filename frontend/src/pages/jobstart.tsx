...
const JOBSTART_FOLDERS: JobStartFolder[] = [
  {
    ...
    photos: [
      ...
      { src: "/assets/JOBSTART/orientation/5.jpg", alt: "" },
      { src: "/assets/JOBSTART/orientation/6.jpg", alt: "" },
      { src: "/assets/JOBSTART/orientation/7.jpg", alt: "" },
      { src: "/assets/JOBSTART/orientation/8.jpg", alt: "" },
    ],
    placeholderCount: 6,
  },
  {
